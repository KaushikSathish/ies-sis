(function () {
    ...
    App.directive('insTc', insTc);
    App.directive('insDebar', insDebar);
    App.directive('insConvocation', insConvocation);
    App.directive('insCertificate', insCertificate);
    ...
    insConvocation.$inject = ['$rootScope', '$compile'];

    function insConvocation($rootScope, $compile) {
        return {
            restrict: 'EA',
            templateUrl: 'app/modules/convocation/convocation_view.html',
    ...
    insCertificate.$inject = ['$rootScope', '$compile'];

    function insCertificate($rootScope, $compile) {
        return {
            restrict: 'EA',
            templateUrl: 'app/modules/certificate/certificate_view.html',
    ...
    function insStudentprofileview($rootScope, $compile) {
        return {
            restrict: 'EA',
            templateUrl: 'app/modules/student-profile/student_profile_view.html',
    ...
    insTc.$inject = ['$rootScope', '$compile'];
    function insTc($rootScope, $compile) {
        return {
            restrict: 'EA',
            templateUrl: 'app/modules/tc-details/tc_details.html',
            controller: 'TCController',
            replace: true
        };
    }

    insDebar.$inject = ['$rootScope', '$compile'];
    function insDebar($rootScope, $compile) {
        return {
            restrict: 'EA',
            templateUrl: 'app/modules/debar/debar.html',
            controller: 'DebarController',
            replace: true
        };
    }
